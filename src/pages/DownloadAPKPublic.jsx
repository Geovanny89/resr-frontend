...
export default function DownloadAPKPublic() {
  ...
  const checkAPKAvailability = () => {
    // Ya no consultamos al backend, asumimos que la APK está en la carpeta estática del frontend
    setApkInfo({
      apkExists: true,
      currentVersion: {
        size: 10485760, // ~10MB aproximado para mostrar
